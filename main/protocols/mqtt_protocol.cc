...
bool MqttProtocol::StartMqttClient(bool report_error) {
    ...
    //========================================================
    // CONFIGURAÇÃO FIXA DO BROKER MQTT (HOME ASSISTANT LOCAL)
    //========================================================
    std::string endpoint = "192.168.1.189:1883";
    std::string client_id = "xiaozhi_robot_fixed";
    std::string username = MQTT_USER;
    std::string password = MQTT_PASSWORD;
    int keepalive_interval = 60;
    publish_topic_ = "xiaozhi/client/message";
...
bool MqttProtocol::OpenAudioChannel() {
    ...
    pdTRUE, pdFALSE, pdMS_TO_TICKS(10000)); if (!(bits & MQTT_PROTOCOL_SERVER_HELLO_EVENT)) {
